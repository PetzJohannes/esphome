...
from esphome.components import empty_fan, output
from esphome.components.empty_fan import validate_preset_modes
...
CosmosFan = cosmos_ns.class_("CosmosFan", cg.Component, empty_fan.Fan)
...
CONFIG_SCHEMA = empty_fan.FAN_SCHEMA.extend(
    {
...
async def to_code(config):
    ...
    await empty_fan.register_fan(var, config)
